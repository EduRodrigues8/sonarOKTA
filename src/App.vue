      ...
      <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div class="flex items-center md:order-2">
            ...
            >
              <div class="py-3 px-4">
                <span class="block text-sm text-gray-900 dark:text-white">Bonnie Blue</span>
                <span
...
#app {
  background: url("https://www.google.com/url?sa=i&url=https%3A%2F%2Fgiphy.com%2Fexplore%2Fstonks&psig=AOvVaw2H2G0Z7jMKVtzTlPhX9zNQ&ust=1645038656957000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCLDR4Ni0gvYCFQAAAAAdAAAAABAJ");
