<template>
  <div class="flex flex-col">
    <div class="-my-1000 sm:-mx-1000 lg:-mx-1000">
          ...
          <table class="min-w-full divide-y divide-slate-1000">
            <thead class="bg-purple-500">
              <tr>
                <th
                  scope="col"
                  class="px-6 py-3 text-left text-xs font-medium text-slate-1000 uppercase tracking-wider"
                >Nome</th>
                <th
                  scope="col"
                  class="px-6 py-3 text-left text-xs font-medium text-slate-1000 uppercase tracking-wider"
            ...
            <tbody class="bg-white divide-y divide-slate-1000">
